...
HD_PWD='D:/vivado_projects/exp4/exp4.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log divider_.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source divider_.tcl -notrace
