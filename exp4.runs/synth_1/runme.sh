...
HD_PWD='D:/vivado_projects/exp4/exp4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log divider_.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source divider_.tcl
